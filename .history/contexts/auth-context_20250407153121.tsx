      ...
      try {
        ...
        if (subError) {
          ...
          if (subscriptions && subscriptions.length === 1) {
            ...
            console.error(
              "[DEBUG] Multiple subscriptions found for user:",
              user.id
            );
            dispatch({
              type: "SET_ERROR",
  ...
  const login = useCallback(
    async (email: string, password: string) => {
      try {
        ...
        console.log(
          "[DEBUG] Calling supabase.auth.signInWithPassword with email:",
        ...
        console.log("[DEBUG] supabase.auth.signInWithPassword returned", {
          data,
          error,
        });
