    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-violet-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          {resetLinkSent ? (
            <div className="text-center py-6">
              ...
              <Button variant="outline" onClick={() => setResetLinkSent(false)} className="w-full">
        ...
        <div className="text-center">
          <Link href="/sign-in" className="inline-flex items-center text-violet-600 hover:text-violet-700 font-medium">
