      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">You haven't created any stories yet</h2>
            <p className="text-slate-600 mb-6">Start your storytelling journey by creating your first magical story!</p>
            <Button
              className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700"
              onClick={() => router.push("/create")}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {storyState.stories.map((story) => (
              <Card key={story.id} className="border-0 shadow-md hover:shadow-lg transition-shadow">
                <CardHeader className="pb-2">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-slate-400">
                    Created: {new Date(story.createdAt || Date.now()).toLocaleDateString()}
                  </p>
                </CardContent>
