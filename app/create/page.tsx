      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 pt-8">
            <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Create Your Story</h1>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Let's craft a magical story together! I'll guide you through the process with a few simple questions.
            </p>
          </div>
          ...
          <Suspense fallback={<Loading />}>
            <StoryWizard onError={(errorMessage) => setError(errorMessage)} />
          </Suspense>
        </div>
      </main>
      <Footer />
