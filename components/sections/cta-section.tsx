        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          <div>
            ...
            <p className="text-xl text-indigo-100 mb-8">
              Join thousands of families creating unforgettable bedtime stories.
            ...
            <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="grid grid-cols-2 gap-4">
                <div
                  ...
                  aria-label="10,000+ stories created"
                >
                  <Sparkles
                    className="h-6 w-6 text-amber-300 mb-2"
                    aria-hidden="true"
                  />
                ...
                <div
                  className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20"
                  aria-label="5,000+ happy families"
                >
                  <Users
                    className="h-6 w-6 text-sky-300 mb-2"
                    aria-hidden="true"
                  />
                ...
                <div
                  className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20"
                  aria-label="50+ unique themes"
                >
                  <BookOpen
                    className="h-6 w-6 text-violet-300 mb-2"
                    aria-hidden="true"
                  />
                ...
                <div
                  className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20"
                  aria-label="Unlimited possibilities"
                >
                  <Wand2
                    className="h-6 w-6 text-indigo-300 mb-2"
                    aria-hidden="true"
                  />
