...
export function ErrorBoundary({ children }: ErrorBoundaryProps) {
          ...
          <CardHeader className="bg-red-50 border-b border-red-100">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription className="text-red-600">We apologize for the inconvenience</CardDescription>
              </div>
            </div>
          </CardHeader>
  ...
  return <ErrorBoundaryComponent componentDidCatch={componentDidCatch}>{children}</ErrorBoundaryComponent>
}
