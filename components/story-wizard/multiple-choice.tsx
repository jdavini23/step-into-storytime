...
export default function MultipleChoice({ options, onSelect, multiSelect = false }: MultipleChoiceProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {options.map((option) => (
          <motion.div key={option.value} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} initial={{ scale: 1 }}>
            <button
              type="button"
