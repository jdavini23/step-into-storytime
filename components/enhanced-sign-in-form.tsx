...
export default function EnhancedSignInForm() {
  ...
  const { login, loginWithGoogle, loginWithFacebook, sendMagicLink } = useAuth()
  ...
  const handlePasswordlessSubmit = async (e) => {
    e.preventDefault()
  ...
  return (
    ...
    >
      ...
      {/* Error message */}
      {errors.general && (
        <div className="bg-red-50 text-red-600 px-4 py-3 rounded-lg text-sm mb-4">{errors.general}</div>
      )}
      ...
      <TabsContent value="password" key="password-tab">
        <form onSubmit={handlePasswordSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Button type="button" variant="outline" onClick={() => handleSocialLogin("facebook")} disabled={isLoading}>
